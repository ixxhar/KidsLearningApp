...
public class Poem1Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        stopService(new Intent(Poem1Activity.this, MyService.class)); //for stopinng the service


        VideoView videoView = findViewById(R.id.video1);

        videoView.setVideoPath("android.resource://" + getPackageName() + "/" + R.raw.poem1);
    ...
    public void trackHistory() { //for tracking history
        ...
        boolean insertData = mDatabaseHelper.addData("Poem1 Activity", timedate);
